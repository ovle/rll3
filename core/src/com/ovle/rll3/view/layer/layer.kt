...
private fun tileTextureRegions(
    ...
    fun hasDoor(x: Int, y: Int): Boolean = hasEntityOnPosition(levelInfo, x, y, DoorComponent::class)
    fun hasLightSource(x: Int, y: Int): Boolean = hasEntityOnPosition(levelInfo, x, y, LightComponent::class)
    fun hasTrap(x: Int, y: Int): Boolean = hasEntityOnPosition(levelInfo, x, y, TrapComponent::class)
